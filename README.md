...
When it comes to **backend**, I'm more _framework-agnostic_—I'm prioritizing gaining an  understanding of design patterns and clean code principles, so I can leverage most tools to build robust and scalable applications. With that said, I've touched Java/Spring, Ruby/Ruby on Rails, & I have plans to learn Laravel & a backend JavaScript framework (TBD).

| **Category**  | **Skills/Tools**                                   |
| ------------- | -------------------------------------------------- |
| **Languages** | TypeScript, JavaScript, Swift, Java, Python, C#    |
| **Frontend**  | Angular, SwiftUI, Web Languages (HTML/CSS)         |
| **Backend**   | Spring Framework, Ruby on Rails, whatever's needed |
...
<table>
  ...
  <td>
    <img src="/assets/250529_CalebWolfe_008_NG.jpg" alt="Portrait of Caleb Wolfe" width="350">
   </td>
 </tr>
</table>
