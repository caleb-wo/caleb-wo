...
|  **Backend**  | Spring Framework, Ruby on Rails, _whatever's needed_         |
| **Learning**  | Angular, Laravel, iOS Development                            |
...
- 🛡️[Udemy Angular Course](https://www.udemy.com/share/107fKM3@8oOsqdl-5L6cDJHaYQX41CqCJ1qDKAaIXqO2ilYHTVoqAJSa5ip7TUs6dMGYDE-veQ==/) <sup>frontend</sup>
  - **Purpose**: Angular has been the framework I've always been interested in. I held off learning it because I wanted to learn vanilla web dev first. Now, I feel ready to adopt a framework & I've gone with Angular. I've enrolled in this class & it's been a clast. Long story short, I **love** it
...
- I am also deeply interested in the moden web browser. I believe it to be the most important & facinating runtime. These browsers are so powerful & the level of backwards compatability & ubiquity offered by them is paramount
