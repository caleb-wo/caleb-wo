...
When it comes to **backend**, I'm more _framework-agnostic_—I prioritize gaining an  understanding of design patterns and clean code principles, so I can leverage most tools to build robust and scalable applications. With that said, I've touch Java/Spring, Ruby on Rails, & I have plans to learn Laravel & a backend JavaScript framework (TBD).
